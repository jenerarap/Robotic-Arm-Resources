# Robotic-Arm-Resources
This project demonstrates how to build a robotic arm completely from scratch using Arduino, servo motors, and a joystick module.
It’s perfect for beginners, engineering students, and anyone interested in learning robotics, electronics, and programming.
----------------------------------------------------------------------------------------------------------------
=Components Used=
...
Power Supply 6V (9V recommended)
